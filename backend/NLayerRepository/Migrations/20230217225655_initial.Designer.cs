...
namespace NLayerRepository.Migrations
{
    ...
    [Migration("20230217225655_initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 18, 1, 56, 55, 468, DateTimeKind.Local).AddTicks(125),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 18, 1, 56, 55, 468, DateTimeKind.Local).AddTicks(141),
                            Name = "Kalem2",
                            Price = 600m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 2, 18, 1, 56, 55, 468, DateTimeKind.Local).AddTicks(144),
                            Name = "Kitap1",
                            Price = 600m,
                            Stock = 20
                        });
