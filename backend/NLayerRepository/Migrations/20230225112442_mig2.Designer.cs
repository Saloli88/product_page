            ...
            modelBuilder.Entity("NLayer.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 24, 42, 89, DateTimeKind.Local).AddTicks(8722),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 24, 42, 89, DateTimeKind.Local).AddTicks(8736),
                            Name = "Kalem2",
                            Price = 600m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 24, 42, 89, DateTimeKind.Local).AddTicks(8738),
                            Name = "Kitap1",
                            Price = 600m,
                            Stock = 20
                        });
