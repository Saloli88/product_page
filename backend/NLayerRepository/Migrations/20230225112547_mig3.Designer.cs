            ...
            modelBuilder.Entity("NLayer.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 25, 47, 98, DateTimeKind.Local).AddTicks(8118),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 25, 47, 98, DateTimeKind.Local).AddTicks(8140),
                            Name = "Kalem2",
                            Price = 600m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 2, 25, 14, 25, 47, 98, DateTimeKind.Local).AddTicks(8142),
                            Name = "Kitap1",
                            Price = 600m,
                            Stock = 20
                        });
